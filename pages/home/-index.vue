<template>
  <div id="home" class="homePage aaa">
    <div>
      ...
      <Row class="homeCommonMargin conclusion translatePart">
        ...
        <div class="concludeImgBox">
          <!--          <img-->
          <!--            v-lazy-load-->
          <!--            data-src="~assets/discoverPage.png"-->
          <!--            alt="深耕海外市场，助力企业探寻商机"-->
          <!--          />-->
          <img
        ...
        <nuxt-link to="/more"><span>立即体验</span></nuxt-link>
      </Row>
      <Row class="homeCommonMargin conclusion overseas">
